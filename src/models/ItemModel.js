...
const ItemModel = {
  ...
  addItem(item, callback) {
    ...
    const values = [item_code, item_name, item_description, catid, item_serial, item_iminumber, item_color, item_brand, item_image, item_produce_date, trndate, status, is_delete];
